    ...
    <div style={{
      ...
      <div style={{ padding: "20px 24px", maxWidth: 1200, margin: "0 auto" }}>
        ...
        {(() => {
          ...
          if (rankingConvenios.length === 0) return null;
          ...
          return (
            <>
              ...
              <div style={{ display: "flex", gap: 14, marginBottom: 16, flexWrap: "wrap" }}>
                ...
                <KPICardNomina icon="👥" label="Clientes por convenio" value={nominaClients.length} color={COLORS.dark} />
                <KPICardNomina icon="💰" label="Monto dispersado" value={formatMoney(totalDisp)} color={COLORS.primary} />
                <KPICardNomina icon="✅" label="Tasa de cierre" value={nominaClients.length > 0 ? `${((rankingConvenios.reduce((s, c) => s + c.dispersados, 0) / nominaClients.length) * 100).toFixed(0)}%` : "0%"} color={COLORS.green} />
              </div>
